                ...
                <div class="recipe__ingredients">
                    <div class="recipe__box">
                        ...
                        <div v-for="(ingredient, index) in form.ingredients" class="recipe__form">
                            ...
                            <button class="btn btn__danger" @click="remove('ingredients')">&times;</button>
                ...
                <div class="recipe__directions">
				    <div class="recipe__directions_inner">
                        ...
                        <div v-for="(direction, index) in form.directions" class="recipe__form">
                            ...
                            </textarea><input type="text" class="form__control" v-model="direction.description" :class="[error[`directions.${index}.description`] ? 'error__bg' : '']"></textarea>
                           
                            <button class="btn btn__danger" @click="remove('directions')">&times;</button>
